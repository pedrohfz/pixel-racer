...
public class PowerUp extends Obstacle {
    ...
    public PowerUp(int lane, float startY) {
        super("gfx/powerup.png", lane, startY);

        if (Gdx.files.internal("gfx/powerup.png").exists()) {
            texture = new Texture(Gdx.files.internal("gfx/powerup.png"));
